            ...
            <div className="bg-slate-50 min-h-screen pt-28 pb-12 px-4">
                <div className="container mx-auto max-w-7xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        {[
                            { title: "Soma Termik Santral", image: "/references/soma.webp", desc: "Süreç yönetimi ve mekanik bakım projelerimizle operasyonel mükemmelliğe destek veriyoruz." },
                            { title: "Kangal Termik Santral", image: "/references/kangal.webp", desc: "Enerji üretim tesislerinde revizyon ve bakım hizmetleri ile enerji sürekliliği sağlıyoruz." },
                            { title: "Sivas İl Özel İdaresi", image: "/references/sivas.webp", desc: "Kamu altyapı ve sosyal hizmet projelerinde güvenilir inşaat çözümlerimizle yer alıyoruz." },
                            { title: "Demir Export", image: "/references/demir_export.webp", desc: "Madencilik sahalarında tesis kurulumu ve endüstriyel revizyon projelerini başarıyla yürütüyoruz." },
                            { title: "Aksu Group", image: null, desc: "5. referansımız için logo ve kısa tanıtım bilgisi buraya eklenecek." }
                        ].map((ref, i) => (
                            <div key={i} className="group bg-white p-6 rounded-3xl shadow-sm border border-slate-100 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 flex flex-col h-full cursor-pointer">
