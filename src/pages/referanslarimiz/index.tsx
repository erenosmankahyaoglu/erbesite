  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Erbe Makine ve İnşaat'ın başarıyla tamamladığı projeler ve referansları."
        />
      </Head>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                image: "/references/sivas.webp",
                desc: "Kamu altyapı ve sosyal hizmet projelerinde güvenilir inşaat çözümlerimizle yer alıyoruz.",
              },
              {
                title: "Demir Export",
                image: "/references/demir_export.webp",
                desc: "Madencilik sahalarında tesis kurulumu ve endüstriyel revizyon projelerini başarıyla yürütüyoruz.",
              },
              {
                title: "Aksu Group",
                image: null,
                desc: "5. referansımız için logo ve kısa tanıtım bilgisi buraya eklenecek.",
              },
            ].map((ref, i) => (
              <div
                key={i}
                className="group bg-white p-6 rounded-3xl shadow-sm border border-slate-100 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 flex flex-col h-full cursor-pointer"
              >
