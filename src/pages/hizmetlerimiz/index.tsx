...
const Hizmetlerimiz = () => {
    ...
    return (
        <div className="min-h-screen bg-[#f4f7f9] pt-20 pb-fluid-xl">
            <Head>
                <title>Hizmetlerimiz | Erbe Makine ve İnşaat</title>
                <meta name="description" content="Erbe Makine ve İnşaat uzmanlık alanları ve sunduğumuz mühendislik çözümleri." />
            </Head>
            ...
            <section className="relative h-[350px] md:h-[450px] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 bg-white/95 backdrop-blur-md px-fluid-md py-fluid-lg md:px-20 rounded-[30px] md:rounded-[40px] shadow-2xl max-w-5xl text-center mx-6">
                    <h1 className="text-3xl md:text-4xl lg:text-4xl font-extrabold text-[#013186] mb-fluid-sm tracking-tight">
                        Bütüncül Hizmet Kapsamımız
                    </h1>
                    <p className="text-base md:text-lg lg:text-xl text-slate-700 font-medium">
                        Mühendislikten anahtar teslim uygulamalara kadar, projenizin her aşamasında Erbe kalitesi ve güvencesi.
                    </p>
                </div>
            </section>

            {/* Grid Layout Section */}
            <section className="py-fluid-xl relative overflow-hidden">
                ...
                <div className="container mx-auto px-fluid-md relative z-10">
                    <div className="flex flex-wrap justify-center gap-fluid-lg">
                        {services.map((service, index) => (
                            <div
                                key={index}
                                className="relative bg-white border border-slate-200/80 rounded-[24px] md:rounded-[28px] p-fluid-md pl-14 md:pl-16 shadow-md shadow-slate-200/50 hover:shadow-xl transition-all duration-300 md:ml-8 flex flex-col justify-center min-h-[140px] w-full sm:w-[calc(50%-1.5rem)] lg:w-[calc(33.333%-2rem)] max-w-[420px] group"
                            >
                                ...
                                <div className="absolute -left-6 md:-left-10 top-1/2 -translate-y-1/2 w-16 h-16 md:w-[84px] md:h-[84px] flex items-center justify-center shrink-0">
                                    ...
                                    <Hexagon fill="white" className="absolute inset-0 w-full h-full text-[#cbd5e1] group-hover:text-[#0171de] transition-colors duration-300 stroke-[1.5]" />
                    ...
                    <div className="mt-fluid-xl flex flex-wrap justify-center gap-4">
                        <Link
                            href="/projelerimiz"
