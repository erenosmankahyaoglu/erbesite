                ...
                <div className="container mx-auto px-4 lg:px-6 grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
                    <div className="space-y-4 text-center lg:text-left">
                        <SectionTitle
                            ...
                            title={<>Endüstriyel Gücün <span className="text-renk2 italic">İnşası.</span></>}
                        ...
                        <div className="flex flex-wrap justify-center lg:justify-start gap-4">
                            <Link href="/hizmetlerimiz" className="bg-renk2 hover:bg-[#015bb3] text-white px-8 py-4 rounded-xl font-bold shadow-xl transition-all hover:scale-105 active:scale-95 text-base min-h-[44px] flex items-center">
                                Hizmetlerimizi Keşfedin
                            </Link>
                            <Link href="/referanslarimiz" className="bg-white border-2 border-slate-200 text-slate-700 px-8 py-4 rounded-xl font-bold hover:bg-slate-100 transition-all text-base min-h-[44px] flex items-center">
                                Referanslarımız
                            </Link>
                        </div>
                    </div>
