...
const values = [
    { icon: Shield, title: 'Güvenilirlik', desc: 'Her projede kalite standartlarına bağlılık.' },
    { icon: Target, title: 'Hassasiyet', desc: 'Mühendislik çözümlerinde detaylara odaklanma.' },
    { icon: Users, title: 'İş Birliği', desc: 'Müşterilerimizle güçlü ve sürdürülebilir ortaklıklar.' },
    { icon: Award, title: 'Deneyim', desc: 'Yılların birikimi ile sektörde öncü adımlar.' },
];
            ...
            <div className="bg-slate-50 min-h-screen">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="space-y-2">
                                <SectionTitle
                                    ...
                                    align="left"
                                    badge="Biz Kimiz?"
                                    title={<>Geleceği Güvenle <span className="text-renk2">İnşa Ediyoruz</span></>}
                    ...
                    <div className="container mx-auto max-w-4xl">
                        <div className="relative bg-white rounded-3xl shadow-lg border border-slate-100 p-8 md:p-14">
                            ...
                            <blockquote className="text-slate-600 text-base md:text-lg leading-relaxed text-center italic">
                                &ldquo;Kurulduğumuz günden bu yana, modern mühendislik yaklaşımlarını geleneksel ustalıkla birleştirerek; mekanik hatlar, hidrolik yapılar
                                ve endüstriyel tesisler konusunda öncü adımlar attık. Erbe Makine ve İnşaat olarak, sadece yapılar değil, aynı zamanda
                                geleceğin endüstriyel standartlarını inşa ediyoruz.&rdquo;
                            </blockquote>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-16 px-6">
                    <div className="container mx-auto max-w-6xl">
                        <SectionTitle title="Değerlerimiz" subtitle="Bizi biz yapan temel ilkeler" />

                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                            {values.map((item, i) => (
                                <div key={i} className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 text-center hover:shadow-lg hover:-translate-y-1 transition-all duration-300 group">
                                    ...
                                    <h3 className="text-lg font-bold text-renk1 mb-2">{item.title}</h3>
