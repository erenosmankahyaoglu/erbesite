...
import { Factory, Construction, Settings, Droplets, Hammer, Flame, ArrowRight, CheckCircle2 } from 'lucide-react';
...
const projectCategories = [
    {
        ...
        description: "Enerji üretim tesislerinde kapsamlı revizyon ve modernizasyon projeleri yürütüyoruz.",
    },
    {
        ...
        description: "Radye temel imalatından konteyner bina inşaatına kadar endüstriyel tesislerin altyapısını oluşturuyoruz.",
    },
    {
        ...
        description: "Kritik mekanik projelerde basınçlı sistemlerden boru hatlarına güvenilir çözümler üretiyoruz.",
    },
    {
        ...
        description: "Su yapıları alanında uçtan uca proje yönetimi ve mühendislik çözümleri sağlıyoruz.",
    },
];
    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Erbe Makine ve İnşaat'ın başarıyla tamamladığı endüstriyel projeler ve faaliyet alanları." />
            </Head>
                ...
                <section className="relative pt-32 pb-16 px-4 overflow-hidden">
                    ...
                    <div className="container mx-auto max-w-7xl relative z-10">
                        <SectionTitle
                            ...
                            title={<>Endüstriyel <span className="text-renk2">Uzmanlığımız,</span> Somut Sonuçlarımız</>}
                        ...
                        <div className="bg-white rounded-2xl shadow-lg border border-slate-100 p-6 md:p-8 grid grid-cols-2 lg:grid-cols-4 gap-6">
                            {stats.map((stat, i) => (
                                <div key={i} className="text-center">
                                    <p className="text-3xl md:text-4xl font-extrabold text-renk2 mb-1">{stat.value}</p>
                    ...
                    <div className="container mx-auto max-w-7xl">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                            {projectCategories.map((category, i) => (
                                ...
                                >
                                    {/* Card Header */}
                                    <div className={`p-6 md:p-8 ${i % 2 === 0 ? 'bg-gradient-to-r from-renk1 to-renk1/90' : 'bg-gradient-to-r from-renk2 to-renk2/90'} text-white relative overflow-hidden`}>
                                    ...
                                    <div className="p-6 md:p-8 flex-1">
                                        <p className="text-xs font-bold uppercase tracking-widest text-slate-400 mb-4">Kapsam</p>
                                        <ul className="space-y-3">
                                            {category.items.map((item, j) => (
                                                <li key={j} className="flex items-start gap-3 text-slate-600 text-sm md:text-base">
                                                    <CheckCircle2 size={18} className="text-renk2 mt-0.5 flex-shrink-0" />
                                                    <span>{item}</span>
                                                </li>
                                            ))}
                                        </ul>
                    ...
                    <div className="container mx-auto max-w-4xl">
                        <div className="relative bg-renk1 rounded-3xl p-8 md:p-14 text-center text-white overflow-hidden">
                            ...
                            <div className="relative z-10">
                                <Hammer size={40} className="mx-auto mb-4 text-white/50" strokeWidth={1} />
                                <h2 className="text-2xl md:text-3xl font-bold mb-4">
                                    Projeniz İçin Çözüm Ortağınız
                                </h2>
                                <p className="text-white/70 max-w-lg mx-auto mb-8 text-base leading-relaxed">
                                    Her proje benzersizdir. Sizin ihtiyaçlarınıza özel mühendislik çözümleri için
