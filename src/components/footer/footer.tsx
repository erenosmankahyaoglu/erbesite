                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <ul className="space-y-2">
                            <li><Link href="/hakkimizda" className="text-slate-600 hover:text-renk2 transition-colors text-sm py-1 inline-block">Hakkımızda</Link></li>
                            <li><Link href="/hakkimizda" className="text-slate-600 hover:text-renk2 transition-colors text-sm py-1 inline-block">Misyon & Vizyon</Link></li>
                            <li><Link href="/hizmetlerimiz" className="text-slate-600 hover:text-renk2 transition-colors text-sm py-1 inline-block">Hizmetlerimiz</Link></li>
                            <li><Link href="/projelerimiz" className="text-slate-600 hover:text-renk2 transition-colors text-sm py-1 inline-block">Öne Çıkan Projeler</Link></li>
                        </ul>
                    </div>
