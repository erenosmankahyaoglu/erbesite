...
const projects = [
    {
        ...
        description: "Enerji üretim tesislerinde ünite genel revizyonundan boru hattı yenilemeye, cephe sacı imalat ve montajına kadar kapsamlı mühendislik çözümleri sunuyoruz.",
        icon: Factory,
    },
    {
        title: "Endüstriyel Temel ve Yapılar",
        description: "Radye temel imalatından konteyner bina inşaatına kadar, endüstriyel tesislerin altyapı ve üstyapı ihtiyaçlarını anahtar teslim karşılıyoruz.",
        icon: Construction,
    },
    {
        title: "Mekanik ve Borulama Hatları",
        description: "Basınçlı buhar hatları, kömür çıkarıcı muhafaza sistemleri ve kazan paneli montajı gibi kritik mekanik projelerde güvenilir çözümler üretiyoruz.",
        icon: Settings,
    },
    {
        title: "Altyapı ve Hidrolik Yapılar",
        description: "Betonarme içme suyu depoları ve isale hatlarından endüstriyel su depolarına kadar, su yapıları alanında uçtan uca proje yönetimi sağlıyoruz.",
        icon: Droplets,
    }
];
    ...
    return (
        <section className="py-12 px-4 bg-slate-50/50">
            <div className="container mx-auto max-w-7xl">
                <SectionTitle title="Öne Çıkan Projelerimiz" subtitle="Başarıyla tamamladığımız endüstriyel projelerimiz" />
